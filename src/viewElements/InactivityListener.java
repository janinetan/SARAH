...
/*	public final static long MOUSE_EVENTS =
	...
	public final static long MOUSE_EVENTS =AWTEvent.MOUSE_EVENT_MASK;
	...
	public InactivityListener(JPanel panel, Action action, int interval)
	{
		this(panel, action, interval, USER_EVENTS);
	}
	public InactivityListener(JButton b, Action action, int interval)
	{
		this(b, action, interval, USER_EVENTS);
	}
	...
	public InactivityListener(JPanel panel, Action action, int minutes, long eventMask)
	{
		this.panel = panel;
		setAction( action );
		setIntervalInMillis( minutes );
		setEventMask( eventMask );
	}
	
	
	public InactivityListener(JButton b, Action action, int minutes, long eventMask)
	{
		this.b = b;
		setAction( action );
		setIntervalInMillis( minutes );
	...
	{
		ActionEvent ae = new ActionEvent(panel, ActionEvent.ACTION_PERFORMED, "");
