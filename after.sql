...
INSERT INTO `event` VALUES (1,NULL,1),(2,NULL,1),(3,1,1),(4,1,1),(5,2,1),(6,2,1),(7,NULL,1),(8,NULL,1),(9,1,1),(10,1,1),(11,1,1),(12,1,1),(13,1,1),(14,2,1),(15,1,1),(16,2,1),(17,2,1),(18,2,1),(19,2,1),(20,NULL,1),(21,NULL,1),(22,NULL,1),(23,NULL,1),(24,NULL,1),(25,NULL,1),(26,NULL,1),(27,NULL,1),(28,NULL,1),(29,NULL,1),(30,NULL,1),(31,1,1),(32,1,1),(33,2,1),(34,2,1),(35,2,1),(37,2,1),(38,1,1),(39,NULL,1),(40,1,1),(41,1,1),(42,1,1),(43,1,1),(44,2,1),(45,2,1),(46,NULL,1),(47,NULL,1),(48,NULL,2),(49,NULL,1),(50,NULL,1),(51,NULL,1),(52,NULL,1),(53,2,1),(54,1,1),(55,NULL,1),(56,2,2),(57,1,1),(58,NULL,1),(59,2,1),(60,2,1),(61,NULL,1),(62,1,1),(63,1,1),(64,2,1),(65,1,1),(66,2,1),(67,2,1),(68,NULL,1);
...
INSERT INTO `object` VALUES (2,'indoorToy','ball','throw','ball','the','the','the','the','the'),(3,'indoorToy','stuffed toy','hug','stuff_toy','the','the','the','the','the'),(4,'outdoorToy','mud','splash','mud','in the','in the','in the','in the','in the'),(5,'outdoorToy','slide','ride','slide','the','the','the','the','the'),(6,'outdoorToy','sandcastle','build','sandcastle','a','a','a','a','a'),(7,'food','sandwich','eat','sandwich','a','a','a','a','a'),(8,'food','fruit','eat','fruits','some','some','some','some','some'),(9,'bodyPart','hands','wash','wash_hands','our','their','his','my','your'),(10,'facialBodyPart','eyes','rub','scratch_face','our','their','his','my','your'),(11,'facialBodyPart','nose','scratch','scratch_nose','our','their','his','my','your'),(12,'facialBodyPart','face','scratch','scratch_face','our','their','his','my','your'),(13,'sanitizer','alcohol','spray','sanitize_hands','some','some','some','some','some'),(14,'sanitizer','alcohol','rub','sanitize_hands','some','some','some','some','some'),(15,'sleepObject','bed','sleep','sleep','on the','on the','on the','on the','on the'),(16,'restObject','bench','rest','bench','on the','on the','on the','on the','on the'),(17,'facialBodyPart','mouth','scratch','scratch_face','our','their','his','my','your'),(18,'indoorToy','pictures','color',NULL,'the','the','the','the','the'),(19,'nose','nose','scratch',NULL,'our','their','his','my','your'),(21,'outdoorToy','swing','ride',NULL,'the','the','the','the','the'),(22,'outdoorToy','rope nets','climb',NULL,'on the','on the','on the','on the','on the'),(23,'outdoorToy','rope nets','play',NULL,'with the','with the','with the','with the','with the'),(24,'outdoorToy','monkey bars','hang',NULL,'on the','on the','on the','on the','on the'),(25,'outdoorToy','monkey bars','climb',NULL,'on the','on the','on the','on the','on the'),(26,'outdoorToy','monkey bars','play',NULL,'with the','with the','with the','with the','with the'),(27,'outdoorToy','bike','ride',NULL,'the','the','the','the','the'),(28,'animal','dog','pet',NULL,'the','the','the','the','the'),(29,'animal','dog','pat',NULL,'the','the','the','the','the'),(30,'animal','dog','touch',NULL,'the','the','the','the','the'),(31,'animal','puppy','pet',NULL,'the','the','the','the','the'),(32,'animal','puppy','pat',NULL,'the','the','the','the','the'),(33,'animal','puppy','touch',NULL,'the','the','the','the','the'),(34,'animal','cat','pet',NULL,'the','the','the','the','the'),(35,'animal','cat','pat',NULL,'the','the','the','the','the'),(36,'animal','cat','touch',NULL,'the','the','the','the','the'),(37,'animal','kitten','pet',NULL,'the','the','the','the','the'),(38,'animal','kitten','pat',NULL,'the','the','the','the','the'),(39,'animal','kitten','touch',NULL,'the','the','the','the','the'),(40,'playAnimal','dog','play fetch',NULL,'with the','with the','with the','with the','with the'),(41,'playAnimal','puppy','play fetch',NULL,'with the','with the','with the','with the','with the'),(42,'outdoorGame','freeze tag','play',NULL,NULL,NULL,NULL,NULL,NULL),(43,'outdoorGame','frisbee','play',NULL,NULL,NULL,NULL,NULL,NULL),(44,'outdoorGame','tug of war','play',NULL,NULL,NULL,NULL,NULL,NULL),(45,'drawSurface','blackboard','draw',NULL,'on the','on the','on the','on the','on the'),(46,'drawSurface','blackboard','write',NULL,'on the','on the','on the','on the','on the'),(49,'drawSurface','paper','draw',NULL,'on a','on a','on a','on a','on a'),(50,'drawSurface','paper','write',NULL,'on a','on a','on a','on a','on a'),(51,'drawSurface','coloring book','draw',NULL,'on the','on the','on the','on the','on the'),(52,'drawSurface','coloring book','color',NULL,'the','the','the','the','the'),(53,'plants','flower','plant',NULL,'a','a','a','a','a'),(54,'plants','flower','water',NULL,'the','the','the','the','the'),(55,'plants','seeds','plant',NULL,'some','some','some','some','some'),(56,'plants','seeds','water',NULL,'the','the','the','the','the'),(57,'plants','plants','water',NULL,'the','the','the','the','the'),(58,'unhealthyFood','chips','eat',NULL,'some','some','some','some','some'),(59,'unhealthyFood','candy','eat',NULL,'some','some','some','some','some'),(60,'unhealthyFood','french fries','eat',NULL,'some','some','some','some','some'),(61,'unhealthyFood','ice cream','eat',NULL,'an','an','an','an','an'),(62,'drinks','water','drink',NULL,'some','some','some','some','some'),(63,'indoorGame','video game','play',NULL,'a','a','a','a','a'),(64,'indoorGame','wii','play',NULL,NULL,NULL,NULL,NULL,NULL),(65,'indoorGame','ipad','play',NULL,'with the','with the','with the','with the','with the'),(66,'bodyPart','hands','clean',NULL,'our','their','his','my','your'),(67,'arts','pictures','paint',NULL,'the','the','the','the','the'),(70,'arts','origami','make',NULL,'an','an','an','an','an'),(72,'pet','dog ','feed',NULL,'the','the','the','the','the'),(73,'pet','dog','hug',NULL,'the','the','the','the','the'),(74,'pet','puppy','feed',NULL,'the','the','the','the','the'),(75,'pet','puppy','hug',NULL,'the','the','the','the','the'),(76,'pet','kitten','feed',NULL,'the','the','the','the','the'),(77,'pet','kitten','hug',NULL,'the','the','the','the','the'),(78,'pet','cat','feed',NULL,'the','the','the','the','the'),(79,'pet','cat','hug',NULL,'the','the','the','the','the'),(80,'pet','fish','feed',NULL,'the','the','the','the','the'),(81,'sutff','toys','arrange',NULL,'the','the','the','the','the'),(82,'stuff','toys','clean up',NULL,'the','the','the','the','the'),(83,'stuff','bed','fix',NULL,'the','the','the','the','the'),(84,'stuff','bed','arrange',NULL,'the','the','the','the','the'),(85,'stuff','room','clean',NULL,'the','the','the','the','the'),(86,'peePlace','comfort room','pee',NULL,'in the','in the','in the','in the','in the'),(87,'peePlace','restroom','pee',NULL,'in the','in the','in the','in the','in the'),(88,'peePlace','wash room','pee',NULL,'in the','in the','in the','in the','in the'),(89,'peePlace','toilet','pee',NULL,'in the','in the','in the','in the','in the'),(90,'sleepObject','couch','sleep',NULL,'on the','on the','on the','on the','on the'),(91,'sports','basketball','play',NULL,NULL,NULL,NULL,NULL,NULL),(92,'sports','soccer','play',NULL,NULL,NULL,NULL,NULL,NULL),(93,'sports','badminton','play',NULL,NULL,NULL,NULL,NULL,NULL),(94,'eyes','eyes','scratch',NULL,'our','their','his','my','your'),(95,'eyes','eyes','cover',NULL,'our','their','his','my','your'),(97,'music','music','dance',NULL,'to the','to the','to the','to the','to the'),(98,'chair','chair','rest',NULL,'on the','on the','on the','on the','on the');
...
INSERT INTO `treatment` VALUES (1,'drink plenty of water',1),(2,'gargle with warm salt water',1),(3,'take cough drops',1),(4,'use throat sprays',1),(5,'take cold medicines',1),(6,'take nasal drops',1),(7,'drink water regularly',2),(8,'eat some salty food',2),(9,'eat food with potassium such as banana',2),(10,'avoid itching and scratching',4),(11,'drink plenty of water',4),(12,'take painkillers for fever',4),(13,'rest',5),(14,'drink plenty of water',5),(15,'staying cool',6),(16,'rest',6),(17,'drink plenty of water',6),(18,'rest',8),(19,'drink plenty of water',8),(21,'take vitamin A supplement',8),(22,'drink a lot of water',9),(23,'eat healthy food',9),(24,'take medicine',9),(25,'rest',9),(26,'drink antibiotics',10),(27,'drink control medicines',3),(28,'use inhalers',3),(29,'take medicine',7),(30,'take preventive shots',7);
...
-- Dump completed on 2017-07-18  1:57:24
