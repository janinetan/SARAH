...
INSERT INTO `message` VALUES (21,'askPrevention'),(7,'commentNegativeFiller + counterPlay + user-askPlay'),(11,'commentNegativeFiller + stateNegativeStatus + transitionToSarah'),(1,'commentPositiveFiller + greetUser + user-askFeeling'),(33,'commentPositiveFiller + stateHealed'),(8,'counterPlay'),(13,'expressDelight'),(28,'expressDisbelief + counterTreatment'),(31,'expressDisbelief + expressStubbornness + transitionToEndDay + expressAppreciation + comeBack + expressFarewell'),(35,'expressDisbelief + succumb + stateRest'),(34,'expressDoubt + suggestFullDayRest'),(40,'expressEmpathy'),(37,'expressFarewell'),(18,'expressNaivety'),(24,'expressNaivety + expressWonder'),(6,'expressPlayfulness'),(39,'expressSick + expressRegret + takeTreatment'),(32,'giveTreatment'),(12,'greetKids + expressWorry + suggestRest + stateSickness'),(16,'greetUser + commentRest + stateTraceOfSymptom'),(9,'ignoreSarah + expressPlayfulness'),(38,'introduceLiam'),(5,'respondToStatus + suggestLiamRest'),(25,'stateAgreement + encouragePrevention + concludePrevention'),(22,'stateAgreement + user-askPrevention'),(20,'stateCauses + stateBodyPart + explainBodyPart'),(43,'stateHealed + thankSarah'),(36,'stateLiamCare + expressAppreciation + stateMoral + comeBack'),(4,'stateNegativeStatus + stateSymptom'),(23,'statePrevention'),(17,'stateSickness'),(27,'stateTreatment'),(30,'stateWarning'),(14,'succumb'),(10,'succumb + transitionToPlay'),(3,'suggestBothRest'),(2,'suggestPlay'),(41,'thankSarah'),(44,'thankUser + stateMoral + wishGoodHealth + expressFarewell'),(15,'transitionToRest'),(26,'transitionToTreatment'),(19,'user-askSickness'),(29,'user-askTreatment'),(42,'wishGoodHealth + stateMoral + expressFarewell');
...
-- Dump completed on 2017-02-28 18:04:02
