...
INSERT INTO `message` VALUES (1,'commentPositiveFiller + greetUser + user-askFeeling'),(2,'suggestPlay'),(3,'suggestBothRest'),(4,'stateNegativeStatus + stateSymptom'),(5,'respondToStatus + suggestLiamRest'),(6,'expressPlayfulness'),(7,'commentNegativeFiller + counterPlay + user-askPlay'),(8,'counterPlay'),(9,'ignoreSarah + expressPlayfulness'),(10,'succumb + transitionToPlay'),(11,'commentNegativeFiller + stateNegativeStatus + transitionToSarah'),(12,'greetKids + expressWorry + suggestRest + stateSickness'),(13,'expressDelight'),(14,'succumb'),(15,'transitionToRest'),(16,'greetUser + commentRest + stateTraceOfSymptom'),(17,'stateSickness'),(18,'expressNaivety'),(19,'user-askSickness'),(20,'stateCauses + stateBodyPart + explainBodyPart'),(21,'askPrevention'),(22,'stateAgreement + user-askPrevention'),(23,'statePrevention'),(24,'expressNaivety + expressWonder'),(25,'stateAgreement + encouragePrevention + concludePrevention'),(26,'transitionToTreatment'),(27,'stateTreatment'),(28,'expressDisbelief + counterTreatment');
...
-- Dump completed on 2017-02-28 17:40:49
